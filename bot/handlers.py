...
**📊 نظام التقارير:**
• /register - التسجيل في النظام
• /my\\_role - عرض دورك وصلاحياتك
• /create\\_report - إنشاء تقرير جديد
• /my\\_reports - عرض تقاريرك
• /view\\_report [رقم] - عرض تقرير محدد

**👔 أوامر المدراء:**
• /department\\_reports - عرض تقارير القسم
• /approve\\_report [رقم] - الموافقة على تقرير

**🎯 أوامر المدراء الأعلى:**
• /create\\_cumulative - إنشاء تقرير تجميعي
• /search - البحث في التقارير
